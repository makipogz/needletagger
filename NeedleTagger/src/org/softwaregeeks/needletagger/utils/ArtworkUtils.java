...
public class ArtworkUtils {
    ...
    public static boolean deleteArtwork(Context context, long album_id)
    {
    	boolean isProcessed = false;
    	String path = MediaContentProviderHelper.getArtworkPath(context, album_id);
        if (path != null)
        {
        	File file = new File(path);
        	if( file.exists() )
        	{
        		isProcessed = file.delete();
        	}
        }
    ...
    public static Bitmap getArtwork(Context context, long album_id, int w, int h) {
    ...
    private static Bitmap getDefaultArtwork(Context context) {
        ...
        return BitmapFactory.decodeStream(
                context.getResources().openRawResource(R.drawable.img_album_unknown), null, opts);
    }
}